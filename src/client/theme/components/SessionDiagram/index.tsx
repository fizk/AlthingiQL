...
export default class SessionDiagram extends React.Component<Props> {
    ...
    render(): React.ReactNode {
        ...
        const from = this.props.sessions.map(session => new Date(session.period.from));
        const to = this.props.sessions.map(session => session.period.to ? new Date(session.period.to) : new Date());
